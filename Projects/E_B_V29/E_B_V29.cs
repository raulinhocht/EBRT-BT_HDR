...
namespace VMS.TPS
{
    public class Script
    {
        ...
        public void Execute(ScriptContext context)
        {
            ...
            sb.AppendLine(" PRUEBA V29 - Resumen Consolidado de Datos con EQD2, Ajuste por Tiempo y Evaluación");
            sb.AppendLine("=====================================================================================");
            ...
            foreach (Course curso in context.Patient.Courses)
            {
                ...
                if (curso.Id.Contains("Cervix") || curso.Id.Contains("EBRT") || curso.Id.Contains("CERVIX") || curso.Id.Contains("Cérvix"))
                {
                    sb.AppendLine("\n========================== SECCIÓN EBRT ==========================");
