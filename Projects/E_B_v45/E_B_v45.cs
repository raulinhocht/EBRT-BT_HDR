...
namespace VMS.TPS
{
    public class Script
    {
        ...
        ("Sigma-HDR", targetVolumeAbs2, alphaBetaOAR, "Sigma")
            ...
            Dictionary<string, List<double>> btEQD2PerFraction = new Dictionary<string, List<double>>();
            foreach (var s in structures) btEQD2PerFraction.Add(s.Item1, new List<double>());
