...
namespace VMS.TPS
{
    public class Script
    {
        ...
        {
            sb.AppendLine(" PRUEBA V38 Resumen Consolidado de Datos EQD2, Ajuste por Tiempo y Evaluación");
            sb.AppendLine("=====================================================================================");
        ...
        private void ShowReportWindow(StringBuilder sb, Dictionary<string, List<double>> btDosesPerFraction = null)
        {
            ...
            if (btDosesPerFraction != null && btDosesPerFraction.Any())
            {
                ...
                var doseChartContainer = new GroupBox
                {
                    ...
                    Content = CreateEQD2ProgressChart(btDosesPerFraction)
                };
